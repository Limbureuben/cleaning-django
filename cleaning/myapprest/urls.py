...
urlpatterns = [
    path('register-cleaner/', RegisterCleanerAPIView.as_view(), name='register-cleaner'),
    ...
    path('staff-cleaning-reports/', StaffCleaningReportsListAPIView.as_view(), name='staff-cleaning-report-list'),
    path('staff-cleaning-reports/<int:pk>/', StaffCleaningReportDeleteAPIView.as_view(), name='staff-cleaning-report-delete'),
